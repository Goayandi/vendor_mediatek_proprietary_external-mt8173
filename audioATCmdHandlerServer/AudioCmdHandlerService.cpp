...
static void DoCustSPHParam(AudioCmdParam &audioCmdParams, void *pParam, AudioCmdHandler *pAudioHandle)
{
    ...
    if (audioCmdParams.param1 == 0)
    {
        ...
        pSpeechParam = (char *)malloc(MAX_BUFSIZE_RECV);
        strcpy(pSpeechParam, responseStr);
...
static void DoCustSPHVolumeParam(AudioCmdParam &audioCmdParams, void *pParam, AudioCmdHandler *pAudioHandle)
{
    ...
    if (audioCmdParams.param1 == 0)
    {
        ...
        strcpy(pSPHVolumeParam, responseStr);
...
static void DoCustACFFindFO(AudioCmdParam &audioCmdParams, void *pParam, AudioCmdHandler *pAudioHandle)
{
	...
	ALOGD("DoCustACFFindFO, Param is %d", audioCmdParams.param1);
	if(audioCmdParams.param1 != 0 && audioCmdParams.param1 != 1 && audioCmdParams
.param1 != 2)
	{
		ALOGE("DoCustACFFindFO, Param is invalid");
	}
	else
	{	
		pFOParam = (char *)malloc(MAX_BUFSIZE_RECV);
	...
	ALOGD("DoCustACFFindFO, responseStr is %s", responseStr);
	sendResponseToATCI(responseStr, strlen(responseStr));
}
...
static void DoGetGainInfoForDisp(AudioCmdParam &audioCmdParams, void *pParam, AudioCmdHandler *pAudioHandle)
{
    ...
    if (audioCmdParams.param1 == 0)  //get data
    {
        ...
        strcpy((char *)pGainForDispInfo, responseStr);
...
static void DoCustGainParam(AudioCmdParam &audioCmdParams, char *pParam, AudioCmdHandler *pAudioHandle)
{
	...
	if (audioCmdParams.param1 == 0)
	{
		...
		strcpy((char *)pGainParam, responseStr);
...
#else
                        sprintf(paramsKeyPaires, "+GCVI:\"TC1:%s\" OK\r\n", value);
#endif
...
int main(int argc, char *argv[])
{
    ...
    ALOGD("AudioCmdHandlerService main() in");
