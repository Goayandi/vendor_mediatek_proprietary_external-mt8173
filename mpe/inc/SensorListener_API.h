...
extern BL SE_sensor_run ( MPE_LOC_SOURCE mode );
extern BL SE_sensor_stop(void);
extern void SE_mtklogger_check ( mtk_int16 record_mode, char *logpath, mtk_int8 log_location);
extern void SE_MPE_client (int mpe_client, MPE_LOC_SOURCE_RESET mode );
extern void SE_set_gpstime(mtk_int32 gps_sec, mtk_int32 leap_sec);
